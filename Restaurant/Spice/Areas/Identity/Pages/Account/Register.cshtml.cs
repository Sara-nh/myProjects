    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.CreateAsync(user, Input.Password);  //creating the new user
                if (result.Succeeded)
                {
                    if (!await _roleManager.RoleExistsAsync(SD.CustomerEndUser))  //assigning roles to our new users, first create the roles if they dont exist.
                    {
